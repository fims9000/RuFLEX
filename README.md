...
- CSV/XLSX data contracts with advisory, user-overridable role proposals; dataset-bound row identities; and MATLAB `.fis` interoperability with source-artifact, semantic-revision and reopen-integrity provenance;
