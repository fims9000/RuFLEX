...
- persistent multi-seed Studies with separate split/training seed provenance, validation-only selection, and Stability Lab evidence (case agreement, HCIR and frozen review gates only for fixed-split training-variability studies);
