...
- generated_at: `2026-04-13T04:33:06.785628+00:00`
...
- profile_status: `template_placeholders_detected`
...
- `PASS` doc:docs/article/paper_draft.pdf: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/paper_draft.pdf
...
- `PASS` doc:docs/article/article_references.json: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/article_references.json
- `PASS` doc:docs/article/submission_state.template.json: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/submission_state.template.json
- `PASS` doc:docs/article/submission_state.json: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/submission_state.json
- `PASS` doc:docs/article/references_ru_gost.md: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/references_ru_gost.md
- `PASS` doc:docs/article/references_en_ieee.md: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/references_en_ieee.md
...
- `PASS` doc:docs/article/shablon_dokladov_illustrated.pdf: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/shablon_dokladov_illustrated.pdf
...
- `PASS` doc:docs/article/conference_template_illustrated_en.pdf: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/conference_template_illustrated_en.pdf
...
- `PASS` doc:docs/article/rinc_draft.pdf: /home/lebedeffson/Code/neurofuzzy_analysis/docs/article/rinc_draft.pdf
- `PASS` article_profile_valid: profile_status=template_placeholders_detected | placeholders=author #1: placeholder Russian author name `И. О. Автор1`; author #1: placeholder English author name `Author One`; author #1: placeholder Russian affiliation `Организация, город, страна`; author #1: placeholder English affiliation `Organization, City, Country`; author #1: placeholder email `author1@example.com`; author #1: placeholder ORCID `0000-0000-0000-0000`; author #2: placeholder Russian author name `И. О. Автор2`; author #2: placeholder English author name `Author Two`; author #2: placeholder Russian affiliation `Организация, город, страна`; author #2: placeholder English affiliation `Organization, City, Country`; author #2: placeholder email `author2@example.com`; author #2: placeholder ORCID `0000-0000-0000-0000`
- `PASS` article_references_valid: references_status=ready
- `PASS` submission_state_valid: submission_state.json schema is valid
...
- `placeholder` author #1: placeholder Russian author name `И. О. Автор1`
- `placeholder` author #1: placeholder English author name `Author One`
- `placeholder` author #1: placeholder Russian affiliation `Организация, город, страна`
- `placeholder` author #1: placeholder English affiliation `Organization, City, Country`
- `placeholder` author #1: placeholder email `author1@example.com`
- `placeholder` author #1: placeholder ORCID `0000-0000-0000-0000`
- `placeholder` author #2: placeholder Russian author name `И. О. Автор2`
- `placeholder` author #2: placeholder English author name `Author Two`
- `placeholder` author #2: placeholder Russian affiliation `Организация, город, страна`
- `placeholder` author #2: placeholder English affiliation `Organization, City, Country`
- `placeholder` author #2: placeholder email `author2@example.com`
- `placeholder` author #2: placeholder ORCID `0000-0000-0000-0000`

## Submission state

- `pending` Подтверждены реальные authors / affiliations / e-mail / ORCID.
- `pending` Стартовый список литературы проверен и приведен к стилю площадки.
- `pending` Итоговые figures и captions окончательно утверждены.
- `pending` В РИНЦ-файл добавлен реальный antiplagiat screenshot.
- `pending` Итоговая верстка `.docx`/`.pdf` просмотрена вручную.

## Manual items

- `pending` При необходимости заполнить или уточнить authors / affiliations / e-mail / ORCID в docs/article/article_profile.json и пересобрать пакет.
