"""Build the source-only RuFLEX Product V1.0.1 centroid-semantics release."""
...
OUT = ROOT / "release" / "RuFLEX_PRODUCT_V1_0_1_SOURCE.zip"
TOP = "RuFLEX_PRODUCT_V1_0_1"
...
SKIP_PARTS = {"__pycache__", ".pytest_cache", "node_modules", "dist", "storybook-static", ".playwright-browsers", ".git", "release", ".product-state", ".agent-state", ".venv"}
